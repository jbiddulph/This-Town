                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('event.store')}}" method="POST">@csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="event_startdate" class="form-control datepicker @error('event_startdate') is-invalid @enderror" value="{{ old('event_startdate') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="event_enddate" class="form-control datepicker @error('event_enddate') is-invalid @enderror" value="{{ old('event_enddate') }}">
